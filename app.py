...
def predict():
    if request.method == 'POST':
        ...
        if prediction==1:
             return render_template('index.html',prediction_text="The Customer will left the bank")
        else:
             return render_template('index.html',prediction_text="The Customer will not left the bank")
